...
<table><tr><td width=70%><table width="561" height="427" border="0" align="left" style="border:1px outset;">
  <tr>
    <td height="307"><?php
	include('aaa.html');?></td>
  </tr>
  <tr>
    <th height="37" bgcolor="#EE6363"><div align="left">DATACARD</div></th>
  </tr>
  <tr>
    <td height="73">Data card plan - buy data card, tata photon, reliances net connection, and mts mblaze at lowest price in india. Themobilestore.in offers best deal in tat photon data card in india. For more details log onto <a href="datacard.php">www.inmobi-accessories-datacard.com</a> </td>
  </tr>
</table>
...
<tr><td colspan="2" width=100%><footer>
<br><br>
