...
<table align=center width=100%><tr><td><table width="660" height="361" border="0" align="center" style="border:1px outset;">
  <tr>
    <th height="36" colspan="3" bgcolor="#EE6363" ><div align="left">Datacard</div></th>
  </tr>
  <tr><td><?php 
include('db2.inc');
$st="select * from mobileinfo where Category='Datacard'";
$rst=mysql_query($st);
