...
<table border=0px align=center><tr><td colspan=3><table width="660" height="361" border="0" align="center" style="border:1px outset;">
  <tr>
    <th height="36" colspan="3" bgcolor="#EE6363" ><div align="left">Charger</div></th>
  </tr>
  <tr><td><?php 
include('db2.inc');
$st="select * from mobileinfo where Category='Charger'";
$rst=mysql_query($st);
